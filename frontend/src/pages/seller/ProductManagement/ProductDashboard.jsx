...
const ProductDashboard = () => {
  ...
  } = useGetProductsQuery({ page: 1, limit: 8, sortBy: "createdAt", sortOrder: "desc" });
  ...
  const stats = [
    ...
    {
      title: "Revenue",
      value: dashboard?.totalRevenue ? currencyFmt.format(dashboard.totalRevenue) : "—",
      icon: <FaChartLine />,
...
"
      ...
      <div>
        ...
        {productsLoading && (
          <div className="text-slate-400 py-10 text-center">Loading products...</div>
        )}
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-slate-400 mt-1">{product.category?.name}</p>
                  ...
                  <div className="flex justify-between items-center mt-5">
                    ...
                    <div>
                      ...
                      <h4 className="font-bold">{product.inventory?.quantity ?? 0}</h4>
                    </div>
                  </div>
              ...
              {products.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 text-slate-400">{item.category?.name}</td>
          ...
          <div className="space-y-5">
            {activities.slice(0, 5).map((activity) => (
              ...
              >
                ...
                <div>
                  <h4 className="font-semibold">{activity.description || activity.action}</h4>
